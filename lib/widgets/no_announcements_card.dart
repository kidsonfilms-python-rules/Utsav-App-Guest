...
class NoAnnouncementsWidget extends ConsumerWidget {
  const NoAnnouncementsWidget({super.key});
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              "Check back later for live updates, schedule changes, and event announcements.",
...
class ErrorAnnouncementsWidget extends ConsumerWidget {
  final String errorMessage;

  const ErrorAnnouncementsWidget({super.key, required this.errorMessage});
